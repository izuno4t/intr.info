...
<title>inter- | www.intr.info</title>
...
if(hasRightVersion) {  // 使用可能なバージョンが検出された場合
    ...
    + '<param name="movie" value="<?=(date("Y", time())=="2007")? "move.swf": "move.swf";?>" /><param name="quality" value="high" /><param name="bgcolor" value="#ffffff" />'
    + '<embed src="<?=(date("Y", time())=="2007")? "move.swf": "move.swf";?>" quality="high" bgcolor="#ffffff" '
    + 'width="100%" height="100%" name="move" align="middle"'
    + 'play="true"'
    + 'loop="false"'
    + 'quality="high"'
    ...
    var alternateContent = '代替 HTML コンテンツをここに配置する必要があります。'
  	+ 'このコンテンツには Macromedia Flash Player が必要です。'
...
<noscript>
	// スクリプトをサポートしていないブラウザ、またはスクリプトが無効になっているブラウザ用に代替コンテンツを提供します。
  	代替 HTML コンテンツをここに配置する必要があります。  このコンテンツには Macromedia Flash Player が必要です。
  	<a href="http://www.macromedia.com/go/getflash/">Flash を取得</a>  	
</noscript>
</body>
</html>
